...
{ 
 ...
 float
   *tipVector_FLOAT   = tr->partitionData[model].tipVector_FLOAT,
   *EV_FLOAT          = tr->partitionData[model].EV_FLOAT;
 ...
 switch(tr->partitionData[model].dataType)
   ...
   case AA_DATA:
     ...
     initGeneric(states, bitVectorAA, 23, fracchanges,
		 ...
		 tipVector, 
		 model, tr->useFloat, EV_FLOAT, tipVector_FLOAT);                   
     break;  
   default:
     assert(0);
   } 
