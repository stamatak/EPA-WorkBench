//$Id: MainFrameApplication.java,v 1.59 2010/03/24 17:20:35 cmzmasek Exp $
...
public final class ExternalMainFrameApplication extends MainFrame {
 ...
 private ExternalMainFrameApplication( final Phylogeny[] phys, final Configuration config, final String title ) {
     ...
     _open_filechooser.addChoosableFileFilter( ExternalMainFrameApplication.xmlfilter );
     _open_filechooser.addChoosableFileFilter( ExternalMainFrameApplication.nhxfilter );
     _open_filechooser.addChoosableFileFilter( ExternalMainFrameApplication.nhfilter );
     _open_filechooser.addChoosableFileFilter( ExternalMainFrameApplication.nexusfilter );
     _open_filechooser.addChoosableFileFilter( ExternalMainFrameApplication.tolfilter );
     _open_filechooser.addChoosableFileFilter( _open_filechooser.getAcceptAllFileFilter() );
     _open_filechooser.setFileFilter( ExternalMainFrameApplication.defaultfilter );
     ...
     _open_filechooser_for_species_tree.addChoosableFileFilter( ExternalMainFrameApplication.xmlfilter );
     _open_filechooser_for_species_tree.addChoosableFileFilter( ExternalMainFrameApplication.tolfilter );
     _open_filechooser_for_species_tree.setFileFilter( ExternalMainFrameApplication.xmlfilter );
     ...
     _save_filechooser.setFileFilter( ExternalMainFrameApplication.xmlfilter );
     _save_filechooser.addChoosableFileFilter( ExternalMainFrameApplication.nhxfilter );
     _save_filechooser.addChoosableFileFilter( ExternalMainFrameApplication.nhfilter );
     _save_filechooser.addChoosableFileFilter( ExternalMainFrameApplication.nexusfilter );
     ...
     _writetopdf_filechooser.addChoosableFileFilter( ExternalMainFrameApplication.pdffilter );
     _writetographics_filechooser = new JFileChooser();
     _writetographics_filechooser.addChoosableFileFilter( ExternalMainFrameApplication.graphicsfilefilter );
     // build the menu bar
     ...
     // App is this big
     setSize( ExternalMainFrameApplication.FRAME_X_SIZE, ExternalMainFrameApplication.FRAME_Y_SIZE );
 ...
 private ExternalMainFrameApplication( final Phylogeny[] phys, final String config_file, final String title ) {
 ...
 void buildAnalysisMenu() {
     ...
     _analysis_menu.addSeparator();
     _analysis_menu.add( _lineage_inference = new JMenuItem( "Infer Ancestor Taxonomies (experimental)" ) );
     customizeJMenuItem( _lineage_inference );
     _lineage_inference
             .setToolTipText( "use Web API for Biology (WABI) at DDBJ to infer ancestor taxonomies/lineages" );
 ...
 void exit() {
     ...
     setVisible( false );
     dispose();
     // Do not exit the raxml workbench
//     System.exit( 0 );
 }
     ...
     if ( ( files != null ) && ( files.length > 0 ) && ( result == JFileChooser.APPROVE_OPTION ) ) {
         for( final File file : files ) {
             if ( ( file != null ) && !file.isDirectory() ) {
                 ...
                 if ( ( _open_filechooser.getFileFilter() == ExternalMainFrameApplication.nhfilter )
                         || ( _open_filechooser.getFileFilter() == ExternalMainFrameApplication.nhxfilter ) ) {
                     try {
                 ...
                 else if ( _open_filechooser.getFileFilter() == ExternalMainFrameApplication.xmlfilter ) {
                 ...
                 else if ( _open_filechooser.getFileFilter() == ExternalMainFrameApplication.tolfilter ) {
                     try {
                 ...
                 else if ( _open_filechooser.getFileFilter() == ExternalMainFrameApplication.nexusfilter ) {
                     try {
 ...
 public void addNewTreefileTab(String treefile) {
     boolean exception = false;
     Phylogeny[] phys = null;
     // Set an initial directory if none set yet
    
     final File file = new File(treefile);
     boolean nhx_or_nexus = false;
     if ( ( file != null ) && !file.isDirectory() ) {
    	 if ( _mainpanel.getCurrentTreePanel() != null ) {
    		 _mainpanel.getCurrentTreePanel().setWaitCursor();
 ...
 private void readSpeciesTreeFromFile() {
     ...
     if ( ( file != null ) && ( result == JFileChooser.APPROVE_OPTION ) ) {
         if ( _open_filechooser_for_species_tree.getFileFilter() == ExternalMainFrameApplication.xmlfilter ) {
             try {
         ...
         else if ( _open_filechooser_for_species_tree.getFileFilter() == ExternalMainFrameApplication.tolfilter ) {
             try {
 ...
 private void writeToFile( final Phylogeny t ) {
     ...
     if ( ( file != null ) && ( result == JFileChooser.APPROVE_OPTION ) ) {
         ...
         if ( _save_filechooser.getFileFilter() == ExternalMainFrameApplication.nhfilter ) {
             exception = writeAsNewHampshire( t, exception, file );
         }
         else if ( _save_filechooser.getFileFilter() == ExternalMainFrameApplication.nhxfilter ) {
             exception = writeAsNHX( t, exception, file );
         }
         else if ( _save_filechooser.getFileFilter() == ExternalMainFrameApplication.xmlfilter ) {
             exception = writeAsPhyloXml( t, exception, file );
         }
         else if ( _save_filechooser.getFileFilter() == ExternalMainFrameApplication.nexusfilter ) {
 ...
 static MainFrame createInstance( final Phylogeny[] phys, final Configuration config, final String title ) {
     return new ExternalMainFrameApplication( phys, config, title );
 }

 static MainFrame createInstance( final Phylogeny[] phys, final String config_file_name, final String title ) {
     return new ExternalMainFrameApplication( phys, config_file_name, title );
 }
