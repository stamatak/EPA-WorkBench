// $Id: Constants.java,v 1.86 2010/04/07 04:30:08 cmzmasek Exp $
...
public final class Constants {
    ...
    final static String         VERSION                                                       = "0.970 beta x";
    final static String         PRG_DATE                                                      = "2010.04.07";
    ...
    final static Color          GUI_BACKGROUND_DEFAULT                                        = new Color (255,255,255);//new Color( 32, 32, 32 );
    final static Color          CHECKBOX_TEXT_COLOR_DEFAULT                                   = new Color (0,0,0);// new Color( 220,220,220 );
    final static Color          CHECKBOX_TEXT_COLOR_ON_DEFAULT                                = new Color (0,0,0);// new Color( 255, 0, 0 );
    final static Color          CHECKBOX_BACKGROUND_COLOR_DEFAULT                             = Constants.GUI_BACKGROUND_DEFAULT;
    final static Color          BUTTON_TEXT_COLOR_DEFAULT                                     = new Color(0,0,0);//new Color( 255,255,255 );
    final static Color          BUTTON_TEXT_COLOR_ON_DEFAULT                                  = CHECKBOX_TEXT_COLOR_ON_DEFAULT;
    final static Color          BUTTON_BACKGROUND_COLOR_DEFAULT                               = new Color(226,236,243);// new Color( 64, 64, 64 );
    final static Color          MENU_BACKGROUND_COLOR_DEFAULT                                 = new Color(255,255,255);// new Color( 0, 0, 0 );
    final static Color          MENU_TEXT_COLOR_DEFAULT                                       = new Color(0,0,0);// new Color( 255,255,255 );
    ...
    static final Dimension      BRANCH_PANEL_MINIMUM_SIZE									  = new Dimension(  40,  40 );
